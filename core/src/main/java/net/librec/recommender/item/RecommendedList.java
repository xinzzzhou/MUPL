...
public interface RecommendedList {
     ...
     */
    List<ItemEntry<Integer, Double>> getItemIdxListByUserIdx(int userIdx);
     ...
     * @return  item index list
     */
    List<ItemEntry<Integer, Double>> removeUserIdx(int userIdx);
    ...
    double getEntryValue(int userIdx, int itemIdx);
