...
//    Table<Integer, Integer, Integer> getActionTable(int i);

    double[][] getUserAction();

    Table<Integer, Integer, Integer> getActionTable(int level);
    Map<Integer, Integer> getItemCount(int action);
}
