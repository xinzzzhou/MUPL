...
public class Maths {
    ...
    public static double standardLogistic(double x) {
//        System.out.println(x - x0);
        return 1.0 / (1.0 + Math.exp(-x));
    }


    public static double standardLogistic(double x, double x0, double max, double k) {
//        System.out.println(x - x0);
        return max / (1.0 + Math.exp(-k * (x - x0)));
    }

    public static double standardLogisticplus(double x, double x0, double max, double k) {
        return max / (1.0 + Math.exp(- Math.pow(2, k * (x - x0))));
    }
}
